...
import { Card } from '@/components/ui/card'; // Importing Card component for better layout
    ...
    return (
        <div className="flex m-0 p-0 flex-col items-center justify-center bg-gray-100 w-screen h-screen">
            <Card className="p-6 shadow-lg rounded-lg w-1/2">
                ...
                <Button><Link className="text-white hover:text-white" to={"./filter"}>Get Started</Link></Button>
